...
def parse_args():
    ...
    parser.add_argument('--AugDirect', type=int, default=21, help='1 for one direction, 2 for bidirection aug edges, 4 for bidegree and bidirection, 20 for bidegree, 21 for another bidegree')
    ...
    parser.add_argument('--dataset', type=str, default='citeseer_npz/', help='data set selection')
