...
def parse_args():
    ...
    # change frequently
    parser.add_argument('--AugDirect', type=int, default=23
    ...
    parser.add_argument('--Direct_dataset', type=str, default='WebKB/texas', help='dgl/cora, ##citeseer_npz/, WebKB/texas')
